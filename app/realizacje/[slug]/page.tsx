...
export default async function RealizationDetailsPage({
  ...
  const paragraphs =
    item.contentParagraphs.length > 0 ? item.contentParagraphs : [item.excerpt];
  ...
  const nextItem =
    currentIndex < realizations.length - 1
      ? realizations[currentIndex + 1]
      : null;

  const rotatedRealizations = [
    ...realizations.slice(currentIndex + 1),
    ...realizations.slice(0, currentIndex),
  ];
  const relatedItems = rotatedRealizations
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="container-main flex-1 py-14">
        ...
        <section className="mx-auto mt-12 max-w-5xl">
          <h2 className="text-5xl font-semibold tracking-tight text-[#223a82]">
            Inne realizacje
          </h2>
            ...
            {relatedItems.map((related) => (
              ...
              >
                ...
                <div className="border-b-[3px] border-[#223a82] p-6">
                  ...
                  <p className="mt-5 line-clamp-2 text-xl leading-8 text-slate-700">
                    {related.excerpt}
                  </p>
                  <Link
                    href={related.link}
